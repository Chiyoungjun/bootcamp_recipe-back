...
CATEGORY_MODEL_PATH = Path("C:/Users/user/Desktop/bootcamp_recipe/project_recipe-back/src/ai/macro9_ml_model.joblib")
...
category_model = loaded.model
feature_builder = loaded.feature_builder
label_encoder = loaded.label_encoder
columns_info = loaded.columns 